...
import type { HowabandaRpcCommand, HowabandaRpcResponse } from './rpc-types.js'

type PendingRequest = {
  resolve: (response: HowabandaRpcResponse) => void
 ...
 */
export class HowabandaRpcChannel {
  ...
  async send(
    ...
    command: Omit<HowabandaRpcCommand, 'id'>,
    ...
    const request: HowabandaRpcCommand = { ...command, id }
