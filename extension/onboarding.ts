...
export const INITIAL_BOOTSTRAP_PROMPT = [
  ...
  'Say new sessions are for when something is badly wedged, or when compaction/context has grown so large that continuing the same branch is hurting the session. Then suggest I run /compact before we continue so the fresh house shape is carried forward.',
