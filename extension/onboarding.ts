...
export const INITIAL_BOOTSTRAP_PROMPT = [
  ...
  'When I say onboarding is done, acknowledge it, give or confirm that short summary, then suggest I run /compact before we continue so the fresh house shape is carried forward.',
